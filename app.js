...
So, if we want to create nested JSX Element Structure we, either wrap all those elements inside a parent element (or) we can use React Fragment Syntax(<>...</>) to achieve the same thing.
